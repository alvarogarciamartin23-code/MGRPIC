     ...
     * ══════════════════════════════════════════ */
    {
      ...
      indicadores: [
        ...
        },
        {
          id:          "J3",
          codigo:      "J.3",
          nombre:      "Historial de incidencias de la unidad",
          descripcion: "Existencia de antecedentes de incidencias en intervenciones previas con activos digitales en la unidad actuante.",
          ayuda:       "Consulte el registro interno de incidencias de la unidad. Valore si existen antecedentes " +
                       "de pérdidas, accesos no autorizados, fallos de custodia u otras incidencias en " +
                       "intervenciones anteriores con criptoactivos.",
          opciones: [
            { valor: 0, nivel: "Bajo",     etiqueta: "Sin incidencias documentadas en intervenciones previas con activos digitales" },
            { valor: 1, nivel: "Moderado", etiqueta: "Algún antecedente de incidencia menor, documentado y resuelto" },
            { valor: 2, nivel: "Alto",     etiqueta: "Incidencias graves previas o ausencia total de registro histórico" }
          ]
        }
      ]
    }
